...
This document provides guidelines for internationalization of the OFIChain Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `OFIChain_en.ts` remains unchanged.
