OFIChain-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/OFIChain/files/OFIChain/OFIChain-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the OFIChain
...
New/changed settings (command-line or OFIChain.conf file)
--------------------------------------------------------
