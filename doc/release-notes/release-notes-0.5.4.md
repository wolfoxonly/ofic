OFIChain version 0.5.4 is now available for download at:
http://sourceforge.net/projects/OFIChain/files/OFIChain/OFIChain-0.5.4/
...
http://gitorious.org/OFIChain/OFIChaind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix OFIChain-Qt notifications under Growl 1.3.
Increase required age of OFIChain-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxOFIChain properly when installing OFIChain-Qt over it. (Windows)
