OFIChain Core version 0.14.2 is now available from:

  <https://OFIChain.org/bin/OFIChain-core-0.14.2/>
...
(in OFIChain Core 0.10.3) it has been disabled by default.
...
Since 0.14.0 the approximate transaction fee shown in OFIChain-Qt when using coin
...
- #10228 `ae479bc` Regenerate OFIChain-config.h as necessary (theuni)
