OFIChain Core version 0.13.2 is now available from:

  <https://OFIChain.org/bin/OFIChain-core-0.13.2/>
...
- #8908 `4a974b2` Update OFIChain-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow OFIChain-tx to create v2 transactions (btcdrak)
