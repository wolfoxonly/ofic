OFIChain Core version 0.11.2 is now available from:

  <https://OFIChain.org/bin/OFIChain-core-0.11.2/>
...
- #6600 `1e672ae` Debian/Ubuntu: Include OFIChain-tx binary
- #6600 `2394f4d` Debian/Ubuntu: Split OFIChain-tx into its own package
