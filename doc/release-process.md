...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the OFIChain.org server
...
- Announce the release:
  ...
  - OFIChain Core announcements list https://bitcoincore.org/en/list/announcements/join/
