...
* OFIChain.conf: contains configuration settings for OFIChaind or OFIChain-qt
* OFIChaind.pid: stores the process id of OFIChaind while running
...
* debug.log: contains debug information and general logging generated by OFIChaind or OFIChain-qt
