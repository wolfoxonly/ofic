...
By default, OFIChaind will dump mempool on shutdown and
...
class MempoolPersistTest(OFIChainTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(1)
        self.start_node(2)
        # Give OFIChaind a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent OFIChaind from writing mempool.dat to disk. Verify that `savemempool` fails")
