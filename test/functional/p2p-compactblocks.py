...
# TestNode: A peer we use to send messages to OFIChaind, and store responses.
...
class CompactBlocksTest(OFIChainTestFramework):
    ...
    # This test actually causes OFIChaind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that OFIChaind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for OFIChaind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # OFIChaind will not send blocktxn responses for blocks whose height is
