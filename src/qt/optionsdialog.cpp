    ...
    fProxyIpValid(true)
{
    ...
    ui->unit->setModel(new OFIChainUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->OFIChainAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting OFIChain."), QMessageBox::Ok);
