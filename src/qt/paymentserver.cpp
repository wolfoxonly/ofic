...
const QString BITCOIN_IPC_PREFIX("OFIChain:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click OFIChain: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start OFIChain: click-to-pay handler");
    else
...
{
    // clicking on OFIChain: URLs creates FileOpen events on the Mac:
