...
static const int64 MAX_MINT_PROOF_OF_WORK = 99999 * COIN;//最大挖到的利息值
...
static const uint256 hashGenesisBlockOfficial("0x0000004c73503c4c3ed7808c11847e46134bf5a90f29aef1e0306755f6553818");
...
#ifdef TESTING
void OFIChainMiner(CWallet *pwallet, bool fProofOfStake, bool fGenerateSingleBlock = false);
#else
...
public:
    ...
    */
    ...
    /** Amount of OFIChains spent by this transaction.
    ...
    /** Amount of OFIChains coming in to this transaction
...
public:
    ...
    /**
     * Duplicate from OFIChainrpc that originaly define this method.
